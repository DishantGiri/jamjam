...
export default function Footer() {
    return (
        <footer className="bg-[#1B3B36] text-white py-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-6">
                    ...
                    <div>
                        <div className="flex items-center mb-4">
                            ...
                            <span className="text-2xl font-bold text-[#ffff] hover:text-[#142C28] transition-colors">
                                JamJam Treks
                            </span>
                        </div>
                    ...
                    <div>
                        ...
                        <div className="flex gap-4">
                            <a href="https://www.instagram.com/jamjamtreksnepal/" className="w-10 h-10 bg-white/10 hover:bg-white/20 hover:scale-110 rounded-lg flex items-center justify-center transition-all duration-200 cursor-pointer">
                                <Instagram className="w-5 h-5" />
                            </a>
                            <a href="https://facebook.com" className="w-10 h-10 bg-white/10 hover:bg-white/20 hover:scale-110 rounded-lg flex items-center justify-center transition-all duration-200 cursor-pointer">
