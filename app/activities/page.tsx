                    ...
                    {loading ? (
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            {filteredActivities.map((activity) => (
                                <div
                                    key={activity.id}
                                    className="bg-white rounded-xl shadow-sm overflow-hidden hover:shadow-xl transition-all duration-300 cursor-pointer border border-gray-100"
                                >
                                    {/* Image */}
                                    <div className="relative h-48 bg-gradient-to-br from-cyan-200 to-blue-200">
                                        ...
                                        <div className="absolute top-3 right-3">
                                            <span className="bg-cyan-500 text-white px-3 py-1 rounded text-xs font-semibold">
                                                {activity.category}
                                            </span>
                                        </div>
                                    </div>
