...
export default function TreksPage() {
    ...
    return (
        <div className="min-h-screen bg-gray-50">
            <Navbar />
            {/* Hero Section */}
            <section className="bg-gradient-to-r from-cyan-500 to-teal-600 text-white py-16 mt-20">
            ...
            <section className="bg-white border-b">
                <div className="max-w-7xl mx-auto px-6 py-5">
                    ...
                    <div className="flex flex-col md:flex-row gap-4 md:items-end">
                        ...
                        <div className="flex-1">
                            ...
                            <div className="flex gap-2">
                                <button
                                    ...
                                    className={`px-4 py-1.5 rounded-full text-sm font-medium transition-all duration-200 ${filterType === 'all'
                                ...
                                <button
                                    ...
                                    className={`px-4 py-1.5 rounded-full text-sm font-medium transition-all duration-200 ${filterType === 'trek'
                                        ? 'bg-cyan-400 text-white'
                                        : 'bg-gray-100 text-gray-700 hover:bg-gray-200'
                                        }`}
                                >
                                ...
                                <button
                                    ...
                                    className={`px-4 py-1.5 rounded-full text-sm font-medium transition-all duration-200 ${filterType === 'package'
                                        ? 'bg-cyan-400 text-white'
                                        : 'bg-gray-100 text-gray-700 hover:bg-gray-200'
                                        }`}
                                >
                        ...
                        <div className="md:w-56">
                            ...
                            <select
                                ...
                                className="w-full px-3 py-1.5 text-sm border border-gray-300 rounded-lg focus:ring-2 focus:ring-cyan-400 focus:border-transparent cursor-pointer"
                            >
                    ...
                    <div className="mt-3 text-xs text-gray-500">
                        Showing <span className="font-semibold text-gray-700">{filteredTreks.length}</span> results
                    </div>
                </div>
            </section>
                            ...
                            {filteredTreks.map((trek) => {
                                ...
                                return (
                                    <Link
                                        key={trek.id}
                                        href={`/treks/${trek.id}`}
                                        className="bg-white rounded-xl shadow-sm overflow-hidden hover:shadow-xl transition-all duration-300 cursor-pointer border border-gray-100 block"
                                    >
                                        {/* Image */}
                                        <div className="relative h-48 bg-gradient-to-br from-blue-200 to-purple-200">
                                            ...
                                            <div className="absolute top-3 right-3">
                                                <span className="bg-cyan-400 text-white px-3 py-1 rounded text-xs font-semibold capitalize">
                                                    {trek.data_type}
                                                </span>
                                            </div>
                                        </div>
