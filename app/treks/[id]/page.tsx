...
import { MapPin, Calendar, ArrowLeft, ImageIcon, ChevronLeft, ChevronRight, DollarSign, X, Phone, Mail, MessageCircle, Mountain } from 'lucide-react';
        ...
        <div className="min-h-screen bg-gray-50">
            ...
            {loading ? (
                ...
                <div className="text-center py-40 mt-20">
                    ...
                    <Link href="/treks" className="text-cyan-600 hover:text-cyan-700 font-medium">
                        ← Back to Treks
                    </Link>
                </div>
            ) : (
                            ...
                            <div className="flex items-start justify-between gap-6 flex-wrap">
                                <div className="flex-1">
                                    <div className="flex items-center gap-3 mb-3">
                                        <span className={`px-3 py-1 rounded-full text-xs font-semibold capitalize ${trek.data_type === 'trek' ? 'bg-cyan-100 text-cyan-700' : 'bg-purple-100 text-purple-700'
                                            }`}>
                                            {trek.data_type}
                                        </span>
