                                ...
                                <div className="space-y-6">
                                    {reviews.map((review) => (
                                        ...
                                        >
                                            ...
                                            {/* Trek/Activity Badge */}
                                            {review.trek_name && (
                                                <div className="inline-block bg-gray-100 text-gray-700 px-3 py-1 rounded text-sm">
                            ...
                            <div className="sticky top-20 bg-white rounded-lg shadow-md p-6">
                                ...
                                <form onSubmit={handleSubmit} className="space-y-4">
                                    ...
                                    <button
                                        type="submit"
                                        disabled={submitting}
                                        className="w-full bg-cyan-500 text-white py-3 rounded-lg font-semibold hover:bg-cyan-600 transition-colors duration-200 flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed"
                                    >
